...
func GetRateLimitData(cfg *netem.Netem) string {
	return fmt.Sprintf(
		`{ enabled: %v }`,
		cfg.HasRateLimitSettings(),
	)
}

func RateLimitSettings(cfg *netem.Netem) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(GetRateLimitData(cfg)))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
